...
namespace Infraestructure.Data.Migrations
{
    ...
    [Migration("20201214010634_Initial")]
            ...
            modelBuilder.Entity("Core.Entities.DonationMoney", b =>
                {
                    ...
                    b.Property<Guid>("TypeDonationId")
                        .HasColumnType("TEXT");
            ...
            modelBuilder.Entity("Core.Entities.DonationMoney", b =>
                {
                    ...
                    b.HasOne("Core.Entities.TypeDonation", "TypeDonation")
                        .WithMany()
                        .HasForeignKey("TypeDonationId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
